INSTALLED_PLUGINS = {
    "plugins": {
            ...
            "parameters": [
                {
                    ...
                    "unit": "dB",
                    "default": 0.83,
                    "normalized": {"from": [-120, 24], "default": 0.0},
            ...
            "parameters": [
                {
                    ...
                    "unit": "Hz",
                    "default": 0.05,
                    "normalized": {"from": [20, 20000], "default": 1000.0},
                ...
                },
                {
                    ...
                    "unit": "dB",
                    "default": 0.0,
                    "normalized": {"from": [-24, 24], "default": 0.0},
                ...
                },
                {
                    ...
                    "unit": None,
                    "default": 0.1,
                    "normalized": {"from": [0, 10], "default": 1.0},
        ...
        "SamplePlayer": {
            ...
            "parameters": [
                {
                    ...
                    "unit": "dB",
                    "default": 0.77,
                    "normalized": {"from": [-120, 36], "default": 0.0},
                ...
                },
                {
                    ...
                    "unit": "s",
                    "default": 0.0,
                    "normalized": {"from": [0, 10], "default": 0.0},
                ...
                },
                {
                    ...
                    "unit": None,
                    "default": 1.0,
                    "normalized": {"from": None, "default": None},
            ...
            "properties": {"sample_file": "Path to .wav file to load"},
            ...
            "parameters": [
                {
                    ...
                    "unit": "dB",
                    "default": None,
                    "normalized": {"from": [-120, 0], "default": None},
            ...
            "parameters": [
                {
                    ...
                    "unit": None,
                    "default": 0.0,
                    "normalized": {"from": [0, 16], "default": 0.0},
                ...
                },
                {
                    ...
                    "unit": None,
                    "default": 0.5,
                    "normalized": {"from": [0, 1], "default": 0.5},
        ...
        "ControlToCV": {
            ...
            "parameters": [
                ...
                },
                {
                    ...
                    "unit": None,
                    "default": 0.5,
                    "normalized": {"from": [-1, 1], "default": 0.0},
            ...
            "parameters": [
                {
                    ...
                    "unit": None,
                    "default": 0.0,
                    "normalized": {"from": [0, 1], "default": 0.0},
                ...
                },
                {
                    ...
                    "unit": "s",
                    "default": 1.0,
                    "normalized": {"from": [0.5, 4.0], "default": 1.0},
            ...
            "parameters": [
                {
                    ...
                    "unit": "dB",
                    "default": 0.79,
                    "normalized": {"from": [-90, 24], "default": 0.0},
                    "description": "Audio playback gain",
                },
                {
                    "name": "playback_speed",
                    "unit": None,
                    "default": 1.0,
                    "normalized": {"from": [0.5, 2.0], "default": 1.0},
                    "description": "The speed at which the audio file is played back.",
                },
                {
                    "name": "fade_time",
                    "unit": "s",
                    "default": 0.0,
                    "normalized": {"from": [0.0, 100.0], "default": 0.0},
                    "description": "The speed at which to fade in or out the audio when starting or stopping in seconds.",
                },
                {
                    "name": "seek",
                    "unit": None,
                    "default": 0.0,
                    "normalized": {"from": [0.0, 1.0], "default": 0.0},
                    "description": "Sets the playback position relative to the start and end of the file.",
                },
                {
                    "name": "playing",
                    "unit": None,
                    "default": 0.0,
                    "normalized": {"from": [0.0, 1.0], "default": 0.0},
                    "description": "Enables or disables audio playback.",
                },
                {
                    "name": "loop",
                    "unit": None,
                    "default": 0.0,
                    "normalized": {"from": [0.0, 1.0], "default": 0.0},
                    "description": "Enables or disables looped playback.",
                },
                {
                    "name": "position",
                    "unit": None,
                    "default": 0.0,
                    "normalized": {"from": [0.0, 1.0], "default": 0.0},
                    "description": "Displays the current playback position relative to the start and end of the file.",
                },
                {
                    "name": "length",
                    "unit": "s",
                    "default": 0.0,
                    "normalized": {"from": [0, 86400], "default": 0.0},
                    "description": "Displays the total length of the file in seconds.",
                },
                {
                    "name": "exp_fade",
                    "unit": None,
                    "default": 0.0,
                    "normalized": {"from": [0.0, 1.0], "default": 0.0},
                    "description": "Enables or disables exponential volume fades when starting or stopping. If disabled, volume fades linearily.Displays the total.",
                },
            ],
            "properties": {
                "file": "The path and name of the file to playback. If file loading fails, this property is updated with an error message."
            },
            "description": "Plugin for streaming large audio files from disk.",
        },
        "Freeverb": {
            "name": "Freeverb",
        ...
        "BW Distortion": {"name": "BW Distortion", "uid": "sushi.brickworks.dist"},
        "BW Drive": {"name": "BW Drive", "uid": "sushi.brickworks.drive"},
        "BW Eq3band": {"name": "BW Eq3band", "uid": "sushi.brickworks.eq3band"},
        "BW Flanger": {"name": "BW Flanger", "uid": "sushi.brickworks.flanger"},
        "BW Fuzz": {"name": "BW Fuzz", "uid": "sushi.brickworks.fuzz"},
        "BW Highpass": {"name": "BW Highpass", "uid": "sushi.brickworks.highpass"},
        "BW Multifilter": {
            "name": "BW Multifilter",
            "uid": "sushi.brickworks.multi_filter",
        },
        "BW Noise Gate": {"name": "BW NoiseGate", "uid": "sushi.brickworks.noise_gate"},
        "BW Notch": {"name": "BW Notch", "uid": "sushi.brickworks.notch"},
        "BW Phaser": {"name": "BW Phaser", "uid": "sushi.brickworks.phaser"},
        "BW Saturation": {
            "name": "BW Saturation",
            "uid": "sushi.brickworks.saturation",
        },
        "BW Tremolo": {"name": "BW Tremolo", "uid": "sushi.brickworks.tremolo"},
        "BW Vibrato": {"name": "BW Vibrato", "uid": "sushi.brickworks.vibrato"},
        "BW Wha": {"name": "BW Wha", "uid": "sushi.brickworks.wha"},
        "BW Simple synth": {
